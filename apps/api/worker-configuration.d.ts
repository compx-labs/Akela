/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: a0fcf08ef674ef1633f168f9308b1b6a)
// Runtime types generated with workerd@1.20260903.1 2026-09-07 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	PRICES: KVNamespace;
	DB: D1Database;
	NFD_API_BASE: "https://api.nf.domains";
	NFD_PARENT_NAME: "akela.algo";
	NFD_PARENT_APP_ID: "3698150696";
	ALGO_INDEXER_BASE: "https://mainnet-idx.algonode.cloud";
	PRICE_API_BASE: "https://coins.llama.fi/prices/current";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NFD_API_BASE" | "NFD_PARENT_NAME" | "NFD_PARENT_APP_ID" | "ALGO_INDEXER_BASE" | "PRICE_API_BASE">> {}
}
